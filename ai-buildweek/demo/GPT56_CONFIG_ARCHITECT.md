...
3. Bu tek, sınırlandırılmış final görevinde görünüyorsa `Max`; yoksa `Extra High` veya `High` gibi hesabındaki en yüksek tek-görev reasoning eforunu seç. `Ultra` paralel alt ajan modudur, reasoning düzeyi değildir.
