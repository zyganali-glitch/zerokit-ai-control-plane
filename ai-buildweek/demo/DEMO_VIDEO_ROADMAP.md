...
8. **Mode / Mod** seçeneği görünüyorsa bu tek ve sınırları belli School görevi için **Max** seçeneğini kullan. Max görünmüyorsa var olmayan bir etiketi söyleme; ekranda gerçekten seçili modu kullan. **Ultra**, paralel alt ajanlarla çalışma modudur; reasoning/effort düzeyi değildir.
9. Ayrı **Reasoning/Effort / Düşünme eforu** seçeneği görünüyorsa hesabındaki en yüksek gerçek düzeyi seç; bu etiket örneğin **Extra High** veya **High** olabilir. Ekranda hangi ad varsa onu değiştirmeden kullan.
10. Seçiciyi bir kez tekrar açıp **GPT-5.6 Sol**, seçili mod ve seçili efor etiketinin görünür olduğunu kontrol et; henüz görev başlatma.
...
5. Model olarak **GPT-5.6 Sol** seç. Tek ve sınırları belli bu görev için görünüyorsa **Max** modunu, reasoning/effort alanında ise hesabında gerçekten bulunan en yüksek düzeyi seç. Videoda seçili gerçek mod ve efor etiketleri görünür olmalıdır; **Ultra**yı reasoning düzeyi diye adlandırma.
...
| `03-model-and-task.mp4` | 25 sn | Codex'te seçiciyi aç, GPT-5.6 Sol'u ve gerçekten seçili mod/efor etiketlerini göster, İngilizce komutu gönder |
...
- Seçili gerçek mod/efor etiketleri görünür ve seslendirmeyle çelişmiyor; Ultra reasoning düzeyi diye sunulmuyor.
